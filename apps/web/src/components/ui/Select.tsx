        ...
        <div className={`w-full ${className}`}>
            ...
            <div className="relative">
                <button
                    ...
                    id={id}
                    name={name}
                    className={`mb-4 w-full rounded-lg bg-white text-sm font-semibold shadow flex cursor-pointer items-center justify-between px-4 py-3 ${disabled ? 'opacity-50 cursor-not-allowed' : ''}`}
