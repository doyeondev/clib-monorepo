      ...
      <header className="flex h-[60px] w-full items-center border border-b-fuchsia-200 px-[15vw] text-xs font-medium sm:px-[10vw]">
        <div className="mx-auto flex h-full w-full">
          <Link to="/" className="title-font flex space-x-1.5 font-medium text-gray-900">
            <img alt="클립" src="/src/assets/icon/clib-icon.svg" className="h-auto w-[30px] justify-center" />
            <img alt="클립" src="/src/assets/icon/clib-text-3d.svg" className="mt-[1px] h-auto w-[44px] justify-center" />
          </Link>
          <div className="ml-auto flex h-full w-fit space-x-4">
            ...
            <Link className="flex cursor-pointer items-center" to="/upload">
              <div className="three-d mx-auto flex w-[120px] items-center justify-center gap-x-2 py-1.5">
                <img alt="문서 업로드" src="/src/assets/icon/upload.svg" className="pointer-events-none h-4 w-4" />
                <p className="text-[13px] text-white">문서 업로드</p>
              </div>
            </Link>
            <a target="_blank" className="flex cursor-pointer items-center" href="https://www.lawinsider.com" rel="noopener noreferrer">
              <div className="three-d mx-auto flex w-[120px] items-center justify-center gap-x-2 py-1.5">
                <img alt="로인사이더" src="/src/assets/icon/lawinsider.svg" className="pointer-events-none h-4 w-4" />
                <p className="text-[13px] text-white">Law Insider</p>
              </div>
            </a>
          </div>
